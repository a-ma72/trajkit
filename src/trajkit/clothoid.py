...
# Minimum (dx^2+dy^2)^1.5 [m^3/param^3] used as a floor in the Frenet-Serret
# curvature denominator guard.
...
# Minimum arc-length step [m] used as a floor when computing
